...
public abstract class Rect extends Group implements Shape {
    ...
    public static void init() {
        vbo = new VertexBuffer(List.of(-0.5f,-0.5f,0.5f,-0.5f,0.5f,0.5f,-0.5f,0.5f));
        ebo = new ElementBuffer(List.of(0,1,2,3));
        vao = new VertexArray().bindVertexBuffer(vbo, 2).elementBuffer(ebo);
    }
    ...
    public Rect(Vector2f pos, Vector2f size, boolean fill) {
        this.pos = pos;
        this.size = size;
        this.fill = fill;
